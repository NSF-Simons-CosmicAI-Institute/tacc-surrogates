...
# Train
print('Calling .train')
node_test.train(data_in,data_out)

# Save
print('Saving model...')
torch.save(node_test,'node_flowbench.pth')
print('done')

# Eval
print('Evaluating...')
node_test = torch.load('node_flowbench.pth',weights_only=False)
x0 = data_in[0:2]
data_pred = node_test.eval(x0)
